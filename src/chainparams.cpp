...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.rebitcoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.rebitcoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.rebitcoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.rebitcoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btc.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.rebitcoin.sprovoost.nl"); // Sjors Provoost
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.rebitcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbtc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.rebitcoin.sprovoost.nl");
