...
#ifndef REBITCOIN_INTERFACES_NODE_H
#define REBITCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a rebitcoin node (rebitcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // REBITCOIN_INTERFACES_NODE_H
