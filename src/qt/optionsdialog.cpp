    ...
    mapper(nullptr)
{
    ...
    ui->rebitcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->rebitcoinAtStartup);
    ...
    ui->rebitcoinAtStartup->setToolTip(ui->rebitcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->rebitcoinAtStartup->setText(ui->rebitcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openReBitcoinConfButton->setToolTip(ui->openReBitcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ReBitcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->rebitcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openReBitcoinConfButton_clicked()
{
