...
#ifndef REBITCOIN_QT_REBITCOINUNITS_H
#define REBITCOIN_QT_REBITCOINUNITS_H
...
/** ReBitcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ReBitcoinUnits: public QAbstractListModel
{
    Q_OBJECT
...
typedef ReBitcoinUnits::Unit ReBitcoinUnit;

#endif // REBITCOIN_QT_REBITCOINUNITS_H
