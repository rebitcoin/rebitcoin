    ...
    platformStyle(_platformStyle)
{
    ...
    // normal rebitcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying rebitcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ReBitcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
