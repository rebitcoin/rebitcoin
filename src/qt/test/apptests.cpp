...
//! Entry point for ReBitcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ReBitcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ReBitcoinGUI tests.
void AppTests::guiTests(ReBitcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ReBitcoinGUI::consoleShown, this, &AppTests::consoleTests);
