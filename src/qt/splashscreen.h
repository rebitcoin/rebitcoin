...
#ifndef REBITCOIN_QT_SPLASHSCREEN_H
#define REBITCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. ReBitcoin Core initialization
...
#endif // REBITCOIN_QT_SPLASHSCREEN_H
