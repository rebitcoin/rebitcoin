...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса ReBitcoin для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Подписывайте сообщения ReBitcoin адресами чтобы подтвердить что это написали именно Вы</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified ReBitcoin addresses</source>
        <translation>Проверяйте сообщения чтобы убедиться что они подписаны конкретными ReBitcoin адресами</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное подключение к сети ReBitcoin</numerusform><numerusform>%n активных подключения к сети ReBitcoin</numerusform><numerusform>%n активных подключений к сети ReBitcoin</numerusform><numerusform>%n активных подключений к сети ReBitcoin</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. ReBitcoin больше не может продолжать безопасную работу и будет закрыт.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Введенный адрес "%1" не является действительным адресом ReBitcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Когда вы нажмете ОК, %1 начнет загружать и обрабатывать полную цепочку блоков %4 (%2ГБ), начиная с самых ранних транзакций в %3, когда %4 был запущен.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для ReBitcoin-клиента на маршрутизаторе. Работает только если Ваш маршрутизатор поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключится к сети ReBitcoin через SOCKS5 прокси.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью ReBitcoin после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить rebitcoin: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>'rebitcoin://' не верный URI. Используйте 'rebitcoin:' вместо этого.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать идентификатор! Это может быть связано с неверным ReBitcoin-адресом или неправильными параметрами идентификатора.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть ReBitcoin.</translation>
    </message>
    <message>
...
Примечание: Так как комиссия рассчитывается на основе каждого байта, комиссия  "100 сатошей за КБ " для транзакции размером 500 байт (половина 1 КБ) в конечном счете, приведет к сбору только 50 сатошей.</translation>
    ...
    <message>
        ...
        <translation>Предупреждение: Неверный ReBitcoin адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ReBitcoin-адрес, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>Сообщение прикрепленное к rebitcoin идентификатору будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть ReBitcoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>ReBitcoin-адрес, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать предыдущий использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение ReBitcoin-адресом</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>ReBitcoin-адрес, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified ReBitcoin address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным ReBitcoin-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>База данных блоков содержит блок, который появляется из будущего. Это может быть из-за некорректно установленных даты и времени на вашем компьютере. Остается только перестраивать базу блоков, если вы уверены, что дата и время корректны.</translation>
    </message>
    <message>
