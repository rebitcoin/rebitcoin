...
#ifndef REBITCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define REBITCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The ReBitcoin Core wallet was originally a collection of unrelated private
...
#endif // REBITCOIN_WALLET_SCRIPTPUBKEYMAN_H
