...
#ifndef REBITCOIN_WALLET_WALLET_H
#define REBITCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this rebitcoin node, and set to 0 for transactions that were created
...
#endif // REBITCOIN_WALLET_WALLET_H
