...
#ifndef REBITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define REBITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // REBITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
