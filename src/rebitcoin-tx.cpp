...
static void SetupReBitcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " rebitcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  rebitcoin-tx [options] <hex-tx> [commands]  Update hex-encoded rebitcoin transaction\n" +
            "or:     rebitcoin-tx [options] -create [commands]   Create hex-encoded rebitcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rebitcoin transaction
