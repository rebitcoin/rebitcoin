...
#ifndef REBITCOIN_TEST_SCRIPTNUM10_H
#define REBITCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from ReBitcoin Core 0.10.0, for cross-comparison.
 */
public:
