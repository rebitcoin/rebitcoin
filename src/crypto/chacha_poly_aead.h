...
#ifndef REBITCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define REBITCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@rebitcoin.
 *
 ...
 *
 * The chacha20-poly1305@rebitcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@rebitcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@rebitcoin are relatively fast in
...
#endif // REBITCOIN_CRYPTO_CHACHA_POLY_AEAD_H
