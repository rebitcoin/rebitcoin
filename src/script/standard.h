...
#ifndef REBITCOIN_SCRIPT_STANDARD_H
#define REBITCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a rebitcoin address
 */
...
/**
 * Generate a ReBitcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // REBITCOIN_SCRIPT_STANDARD_H
