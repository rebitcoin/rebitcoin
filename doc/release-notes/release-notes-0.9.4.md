...
- The Ubuntu PPA from https://launchpad.net/~rebitcoin/+archive/ubuntu/rebitcoin
- A third-party or self-compiled ReBitcoin Core

upgrade to ReBitcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
