ReBitcoin Core version 0.16.1 is now available from:

  <https://rebitcoincore.org/bin/rebitcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting rebitcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure rebitcoind processes are cleaned up when tests end (sdaftuar)
