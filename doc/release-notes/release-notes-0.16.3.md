ReBitcoin Core version 0.16.3 is now available from:

  <https://rebitcoincore.org/bin/rebitcoin-core-0.16.3/>
...
been discovered in ReBitcoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` rebitcoinconsensus: invalid flags error should be set to `rebitcoinconsensus_err` (afk11)
