ReBitcoin Core version *0.15.2* is now available from:

  <https://rebitcoincore.org/bin/rebitcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in rebitcoin-tx (TheBlueMatt)
