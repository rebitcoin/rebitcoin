ReBitcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/rebitcoin/files/ReBitcoin/rebitcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the ReBitcoin
...
New/changed settings (command-line or rebitcoin.conf file)
--------------------------------------------------------
