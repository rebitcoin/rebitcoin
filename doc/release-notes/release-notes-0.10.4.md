ReBitcoin Core version 0.10.4 is now available from:

  <https://rebitcoin.org/bin/rebitcoin-core-0.10.4/>
...
- #6953 `43c2789` Split rebitcoin-tx into its own package
- #6953 `dfe0d4d` Include rebitcoin-tx binary on Debian/Ubuntu
