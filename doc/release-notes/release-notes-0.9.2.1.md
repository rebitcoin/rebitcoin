ReBitcoin Core version 0.9.2.1 is now available from:

  https://rebitcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 REBTC to 0.01 REBTC
...
- Fix "Start rebitcoin on system login"
