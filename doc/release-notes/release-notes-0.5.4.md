ReBitcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/rebitcoin/files/ReBitcoin/rebitcoin-0.5.4/
...
http://gitorious.org/rebitcoin/rebitcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix ReBitcoin-Qt notifications under Growl 1.3.
Increase required age of ReBitcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxReBitcoin properly when installing ReBitcoin-Qt over it. (Windows)
