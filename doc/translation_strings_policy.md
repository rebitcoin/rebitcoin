...
This document provides guidelines for internationalization of the ReBitcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rebitcoin_en.ts` remains unchanged.
