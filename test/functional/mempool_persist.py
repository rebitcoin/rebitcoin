...
By default, rebitcoind will dump mempool on shutdown and
...
class MempoolPersistTest(ReBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent rebitcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
