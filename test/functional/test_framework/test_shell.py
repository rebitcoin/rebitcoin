...
class TestShell:
    """Wrapper Class for ReBitcoinTestFramework.

    The TestShell class extends the ReBitcoinTestFramework
    ...
    class __TestShell(ReBitcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ReBitcoinTestFramework child class.
            self.num_nodes = 1
