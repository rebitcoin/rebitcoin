...
"""Verify that starting rebitcoin with -h works as expected."""

from test_framework.test_framework import ReBitcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ReBitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rebitcoin with -h for help text")
        ...
        self.log.info("Start rebitcoin with -version for version information")
        ...
        self.log.info("Start rebitcoind with -fakearg to make sure it does not start")
