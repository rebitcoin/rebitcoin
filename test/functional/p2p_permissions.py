...
class P2PPermissionsTests(ReBitcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].rebitcoinconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].rebitcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
