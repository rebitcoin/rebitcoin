...
[good first issue](https://github.com/rebitcoin/rebitcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.

Communication Channels
----------------------

Most communication about ReBitcoin Core development happens on IRC, in the
#rebitcoin-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/rebitcoin-core-dev/](http://www.erisian.com.au/rebitcoin-core-dev/)
and [http://gnusha.org/rebitcoin-core-dev/](http://gnusha.org/rebitcoin-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/rebitcoin-dev)
...
[Translation Process](https://github.com/rebitcoin/rebitcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ReBitcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall ReBitcoin
Network Protocol consensus changes.

Whether a pull request is merged into ReBitcoin Core rests with the project merge
...
Patches that change ReBitcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ReBitcoin consensus, it must have been
