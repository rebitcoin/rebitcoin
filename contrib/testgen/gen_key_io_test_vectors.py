...
bech32_templates = [
  ...
  ('be',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('be',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('be',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
