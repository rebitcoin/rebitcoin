# Bootstrappable ReBitcoin Core Builds

This directory contains the files necessary to perform bootstrappable ReBitcoin
Core builds.
...
- 24GB of free disk space on the partition that the ReBitcoin Core git repository
  resides in
...
For a ReBitcoin Core depends development environment, simply invoke
...
From the top of a clean ReBitcoin Core repository:
...
To use dongcarl's substitute server for ReBitcoin Core builds after having
