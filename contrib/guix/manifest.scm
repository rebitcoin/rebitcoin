...
(define* (make-rebitcoin-cross-toolchain target
                                  #:key
...
desirable for building ReBitcoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-rebitcoin-cross-toolchain "i686-linux-gnu")
       (make-rebitcoin-cross-toolchain "x86_64-linux-gnu")
       (make-rebitcoin-cross-toolchain "aarch64-linux-gnu")
       (make-rebitcoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-rebitcoin-cross-toolchain "riscv64-linux-gnu"
