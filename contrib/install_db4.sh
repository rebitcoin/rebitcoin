...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the rebitcoin repository."
  exit 1
fi
...
# See https://github.com/rebitcoin/rebitcoin/issues/16064
...
echo 'When compiling rebitcoind, run `./configure` in the following way:'
echo
